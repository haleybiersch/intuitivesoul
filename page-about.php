...
<div class="row">
    <br><h3 class="cohostp">Background:</h3><p><img class="cohosti d-block" src="<?php echo get_template_directory_uri(); ?>/images/laurie.jpg" alt="Portrait of Laurie" width="150" align="left"/> I am a Professional &amp Intuitive Counselor. I incorporate my professional qualifications that include a Bachelor’s degree in Social Work, Neuro-Linguistic Programming (NLP) and mBit Coach and Trainer, among other certifications, with my Intuitive Counseling and natural Clairsentient and Claircognizant abilities.<br>
